export async function GET() {
    ...
    { id: 'p6', name: 'I-Pad', price: 1000, category: 'Electronics', stock: 4 },
    ...
    { id: 'p10', name: 'Lights', price: 15, category: 'Appliances', stock: 53 },
    { id: 'p11', name: 'Fan', price: 150, category: 'Appliances', stock: 7 }
    ];
